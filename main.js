  ...
  (function() {
    ...
    function init(options) {
      ...
      searchEl = document.querySelector(
        options.searchSelector || "#js-super-search"
      );
      searchInputEl = document.querySelector(
        options.inputSelector || "#js-super-search__input"
      );
      searchResultsEl = document.querySelector(
        options.resultsSelector || "#js-super-search__results"
      );
